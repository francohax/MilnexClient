...
export default class Lock extends React.Component {
  ...
  render() {
    return (
      <div id='auth-container' className='lockpage fadeIn animated'>
        <div id='auth-row'>
          <div id='auth-cell'>
            <Grid>
              <Row>
                ...
                <Col sm={12} className='text-center'>
                  <Form onSubmit={::this.back}>
                    <FormGroup
                      ...
                      <ControlLabel>{this.props.user.username}</ControlLabel>
                      <img src={this.props.user.avatar} width='128' height='128' alt='avatar' />
